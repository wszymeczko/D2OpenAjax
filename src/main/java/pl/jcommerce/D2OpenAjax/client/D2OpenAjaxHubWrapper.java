...
import pl.jcommerce.D2OpenAjax.client.callbacks.ConnectCompletedCallback;
import pl.jcommerce.D2OpenAjax.client.callbacks.DataReceivedCallback;
import pl.jcommerce.D2OpenAjax.client.callbacks.MessageStoredCallback;
...
public class D2OpenAjaxHubWrapper {
	...
	public native void connectHub(ConnectCompletedCallback connectCallback) /*-{
		...
		function onInitWidget(message) {
			connectCallback.@pl.jcommerce.D2OpenAjax.client.callbacks.ConnectCompletedCallback::onInit(Ljava/lang/String;)(message);
		}

		function onActiveWidget(bActiveFlag) {
			connectCallback.@pl.jcommerce.D2OpenAjax.client.callbacks.ConnectCompletedCallback::onActive(Z)(bActiveFlag);
		}
	}-*/;
	...
	public native void sendMessage(String channel, D2OpenAjaxMessageWrapper message) /*-{
		var d2Hub = this.@pl.jcommerce.D2OpenAjax.client.D2OpenAjaxHubWrapper::d2OpenAjaxHub;
		var d2Message = message.@pl.jcommerce.D2OpenAjax.client.D2OpenAjaxMessageWrapper::d2OpenAjaxMessage;
	...
	public native void subscribeToChannel(String channel, DataReceivedCallback dataReceived, boolean handleMessageIfInactive) /*-{
		...
		function callbackDataReceived(channel, message) {
			dataReceived.@pl.jcommerce.D2OpenAjax.client.callbacks.DataReceivedCallback::onDataReceived(Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(channel, message);
		}
	}-*/;
	...
	private native void subscribeToChannels(JsArrayString channels, DataReceivedCallback dataReceived, boolean handleMessageIfInactive) /*-{
		...
		function callbackDataReceived(channels, message) {
			dataReceived.@pl.jcommerce.D2OpenAjax.client.callbacks.DataReceivedCallback::onDataReceived(Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(channels, message);
		}
	}-*/;
	...
	public native void storeMessage(String channel, String message, MessageStoredCallback messageStored, boolean handleMessageIfInactive) /*-{
		...
		function callbackStoreMessage(channel, message) {
			messageStored.@pl.jcommerce.D2OpenAjax.client.callbacks.MessageStoredCallback::onMessageStored(Ljava/lang/String;Ljava/lang/String;)(channel, message);
		}
	}-*/;
